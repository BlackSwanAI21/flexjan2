...
export function formatInstructions(formData: BasicTemplateFormData): string {
  return `
...
Once qualified then:
1) Tell them that we're confident we can help them, would they be free to speak with an advisor now?
2) if they're not free to speak with an adviser now, ask them what day and time they're free to speak
3) When they agree to a time to talk tell them we will call from this phone number: ${formData.phone} (do not send the phone number until they agree a time to speak)
###
